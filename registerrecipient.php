...
include('connection.php');
	...
	$insertquery="INSERT INTO recipient (`Name`, `Age`, `Address`, `Phone`, `BloodType`, `Allergy`) VALUES ('$name', '$age','$address','$phone','$blood','$allergy')";
...
<html>
    ...
    <body>
        <h4>Recipient Registration Form</h4>
			<form method="POST">
			    <div>
